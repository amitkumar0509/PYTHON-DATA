...
class Teacher:
    def __init__(self, name, employee_id):
        ...
        self.assigned_classes = []  # Tracks the classes the teacher is assigned to
        self.subject = []
...
class Classroom:
    def __init__(self, classroom_number):
        ...
        self.students = []  # Fixed typo: changed from 'self.student' to 'self.students'
        self.teachers = []
        self.courses = []
    ...
    def assign_teacher(self, teacher):
        ...
        teacher.assigned_classes.append(self)  # Track the class the teacher is assigned to
